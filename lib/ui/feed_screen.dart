...
class _FeedScreenState extends State<FeedScreen> {
    ...
    getDataAllPost() {
        for (var i = 0; i < 10; i++) {
            Post pos = new Post(i, "posting " + i.toString() , i*2, i, '2020-27-04', 72, "https://picsum.photos/200/300", "restno no " + i.toString(),"https://picsum.photos/200/300");
            posts.add(pos);
        }
                        ...
                        child: CircleAvatar(
                                child: ClipOval(
                                    child: Image(
                                        height: 50.0,
                                        width: 50.0,
                                        image: AssetImage(posts[index].restoImageUrl),
                                        fit: BoxFit.cover,
                                    ),
                                ),
                            ),
